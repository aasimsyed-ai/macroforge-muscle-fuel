...
export const SECTION_GUIDES: Record<GuideSectionId, SectionGuideContent> = {
  food: {
    ...
    terms: [
      ...
      { term: "Frequent", meaning: "Foods you log often, ranked by how many times you've had them." },
      ...
      { term: "Barcode", meaning: "Scan a packaged food's barcode for its exact label nutrition." },
      {
        ...
        meaning: "Check and correct the estimated calories/macros before you save — nothing saves without your OK.",
      },
    ],
  ...
  workout: {
    ...
    terms: [
      ...
      { term: "Equipment", meaning: "Narrows the exercise/variant options to what's actually relevant." },
      ...
      { term: "Rest", meaning: "How long you rested afterwards, in seconds — defaults to 60s, editable." },
      {
      ...
      },
      {
        ...
        meaning: "Whether this session beat your last comparable one — more weight, more reps, or more sets.",
      },
    ],
  ...
  progress: {
    ...
    terms: [
      ...
      { term: "This month", meaning: "A longer-term view — this month so far vs. last month." },
      {
        ...
        meaning: "Each exercise is judged on its own: Progressed, Maintained, Decreased, or Not enough data yet — never a single overall score.",
      },
    ],
